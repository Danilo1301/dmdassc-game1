Entity = class {
  ...
  draw(x, y) {
    ...
    Render.drawImage(this.sprite, -(this.size*3)/2, -this.size*3, this.size*3, this.size*3);
    Render.imageSmoothingEnabled = true

    Render.ctx.fillStyle = `rgba(${this.color[0]}, ${this.color[1]}, ${this.color[2]}, 0.8)`;
...
EntityNPC = class extends Entity {
  constructor() {
    super();
